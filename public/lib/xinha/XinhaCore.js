...
Xinha.Config = function()
{
  ...
  */
  ...
  // TODO : Editor 출력 스타일 추가
  this.pageStyle = `.HStyle0 {
			style-name:"바탕글";
			margin-top:0.0pt;
			margin-bottom:0.0pt;
			text-align:justify;
 ...
 /** You can tell the fullscreen mode to leave certain margins on each side.<br />
  ...
  /** 드롭다운에서 현재 활성화되어 선택된 "포맷블록" 옵션을 결정하는 데 사용할 사용자 지정 기능을 제공할 수 있습니다.
  ...
  this.btnList =
  {
    bold: [ "진하게", Xinha._lc({key: 'button_bold', string: ["bold.svg",0,-1]}, 'Xinha'), false, function(e) { e.execCommand("bold"); } ],
    italic: [ "기울임", Xinha._lc({key: 'button_italic', string: ["italic.svg",0,-1]}, 'Xinha'), false, function(e) { e.execCommand("italic"); } ],
    underline: [ "밑줄", Xinha._lc({key: 'button_underline', string: ["ed_buttons_main.png",2,0]}, 'Xinha'), false, function(e) { e.execCommand("underline"); } ],
    strikethrough: [ "취소선", Xinha._lc({key: 'button_strikethrough', string: ["ed_buttons_main.png",3,0]}, 'Xinha'), false, function(e) { e.execCommand("strikethrough"); } ],
    subscript: [ "아래 첨자", Xinha._lc({key: 'button_subscript', string: ["ed_buttons_main.png",3,1]}, 'Xinha'), false, function(e) { e.execCommand("subscript"); } ],
    superscript: [ "위 첨자", Xinha._lc({key: 'button_superscript', string: ["ed_buttons_main.png",2,1]}, 'Xinha'), false, function(e) { e.execCommand("superscript"); } ],

    justifyleft: [ "왼쪽 정렬", ["ed_buttons_main.png",0,0], false, function(e) { e.execCommand("justifyleft"); } ],
    justifycenter: [ "가운데 정렬", ["ed_buttons_main.png",0,0], false, function(e){ e.execCommand("justifycenter"); } ],
    justifyright: [ "오른쪽 정렬", ["ed_buttons_main.png",0,0], false, function(e) { e.execCommand("justifyright"); } ],
    justifyfull: [ "양쪽 정렬", ["ed_buttons_main.png",0,0], false, function(e) { e.execCommand("justifyfull"); } ],
    ...
    insertorderedlist: [ "문단 번호 적용", ["ed_buttons_main.png",0,3], false, function(e) { e.execCommand("insertorderedlist"); } ],
    insertunorderedlist: [ "글머리표 적용", ["ed_buttons_main.png",1,3], false, function(e) { e.execCommand("insertunorderedlist"); } ],

    outdent: [ "내어쓰기", ["ed_buttons_main.png",1,2], false, function(e) { e.execCommand("outdent"); } ],
    indent: [ "들여쓰기",["ed_buttons_main.png",0,2], false, function(e) { e.execCommand("indent"); } ],
    forecolor: [ "글자색", ["ed_buttons_main.png",0,0], false, function(e) { e.execCommand("forecolor"); } ],
    hilitecolor: [ "배경색", ["ed_buttons_main.png",0,0], false, function(e) { e.execCommand("hilitecolor"); } ],

    undo: [ "실행 취소", ["ed_buttons_main.png",4,2], false, function(e) { e.execCommand("undo"); } ],
    redo: [ "취소 복원", ["ed_buttons_main.png",5,2], false, function(e) { e.execCommand("redo"); } ],
    ...
    selectall: [ "전체선택", ["selectall.svg",-4,-4], false, function(e) {e.execCommand("selectall");} ],

    inserthorizontalrule: [ "수평선 긋기", ["horizontalrule.svg",-4,-3], false, function(e) { e.execCommand("inserthorizontalrule"); } ],
    createlink: [ "하이퍼링크", ["ed_buttons_main.png",6,1], false, function(e) { e.execCommand("createlink"); } ],
    fixlink: [ "링크수정", ["fixlink.svg",0,0], false, function(e) { e.execCommand("fixlink"); } ],
    checklink: [ "링크확인", ["checklink.svg",0,0], false, function(e) { e.execCommand("checklink"); } ],
    unlink: [ "링크삭제", ["unlink.svg",-2,0], false, function(e) { e.execCommand("unlink"); } ],
    insertimage: [ "이미지 넣기", ["ed_buttons_main.png",6,3], false, function(e) { e.execCommand("insertimage"); } ],
    inserttable: [ "표 삽입", ["inserttable.svg",-2,-2], false, function(e) { e.execCommand("inserttable"); } ],

    htmlmode: [ "HTML소스변환", ["source.svg",-3,-3], true, function(e) { e.execCommand("htmlmode"); } ],
    toggleborders: [ "투명테두리", ["border.svg",-3,-3], false, function(e) { e._toggleBorders(); } ],
    print: [ "프린트출력", ["ed_buttons_main.png",8,1], false, function(e) { if(Xinha.is_gecko) {e._iframe.contentWindow.print(); } else { e.focusEditor(); print(); } } ],
    saveas: [ "Save as", ["ed_buttons_main.png",9,1], false, function(e) { e.execCommand("saveas",false,"noname.htm"); } ],
    about: [ "About this editor", ["about.svg",-1,-1], true, function(e) { e.getPluginInstance("AboutBox").show(); } ],
    showhelp: [ "Help using editor", ["showhelp.svg",-3,-3], true, function(e) { e.execCommand("showhelp"); } ],

    splitblock: [ "Split Block", "splitblock.svg", false, function(e) { e._splitBlock(); } ],
    lefttoright: [ "오른쪽 정렬", ["ed_buttons_main.png",0,2], false, function(e) { e.execCommand("lefttoright"); } ],
    righttoleft: [ "왼쪽 정렬", ["righttoleft.svg",-2,-2], false, function(e) { e.execCommand("righttoleft"); } ],
    ...
    clearfonts: [ "Clear Inline Font Specifications", ["clearformatting.svg",-2,-2], true, function(e) { e._clearFonts(); } ],
   ...
   *  called in sequence.  The element may contain a class selector ( a.somethingSpecial ) merged
   *  
   */
  ...
  */
  ...
  this.iconList = 
  {
    dialogCaption : _editor_url + 'images/small-icon.gif',
    wysiwygmode : [_editor_url + 'images/unsource.svg',-3,-3]
  };
    ...
    if ( !el && btn )
    {
      ...
      obj.swapImage = function(newimg)
      {
        if ( typeof newimg != 'string' )
        {
          ...
          img.style.top  = newimg[2] ? ('-' + ( (newimg[2] + 1)) + 'px') : '-18px';
          img.style.left = newimg[1] ? ('-' + ( (newimg[1] + 1)) + 'px') : '-18px';
        }
        else
        {
...
Xinha.makeBtnImg = function(imgDef, doc)
{
  ...
  else
  {
    ...
    i_contain.style.top = '-3px';
    i_contain.style.left = '-3px';
  }

  // i_contain.style.overflow = 'hidden';
  // 사이즈 변경함 18px - > 25px
  i_contain.style.width = "25px";
  i_contain.style.height = "25px";
  ...
  else
  {
    ...
    // 아이콘 X,Y 좌표이동 원래는 이미지에서 좌표로 이동시키는 방식임.
    // img.style.top  = imgDef[2] ? ('-' + (18 * (imgDef[2] + 1)) + 'px') : '-18px';
    // img.style.left = imgDef[1] ? ('-' + (18 * (imgDef[1] + 1)) + 'px') : '-18px';
    img.style.top  = imgDef[2] ? ('-' + ((imgDef[2] + 1)) + 'px') : '2px';
    img.style.left = imgDef[1] ? ('-' + ((imgDef[1] + 1)) + 'px') : '2px';
  }
...
Xinha.prototype.setMode = function(mode)
{
  ...
  switch ( mode )
  {
    ...
    case "wysiwyg":
      ...
      this._toolbarObjects.htmlmode.swapImage([this.imgURL('images/source.svg'),-3,-3]); 
      this.setCC("textarea");
        ...
        if ( !text )
        {
          try
          {
            ...
            // FIXME: the following line is scary.
              ...
              {
                //options은 선택된 글자의 오브젝트( 글자폰트, 글자크기 )를 가지고 있음
...
Xinha.prototype._comboSelected = function(el, txt)
{
  ...
  switch (txt)
  {
    ...
    case "formatblock":
      ...
      // value는 선택된 스타일의 정보가 들어있음 h1,h2,h3등등
      if ( !value )
      {
      	this.updateToolbar();
      	break;
