...
PSLocal.prototype._prepareBackend = function() {
  ...
  if (!google.gears.factory.hasPermission) {
    if (!google.gears.factory.getPermission('Xinha', editor.imgURL('/images/small-icon.gif'), Xinha._lc( 'Enable Gears in order to use local document storage and configuration.', 'PSLocal' ))) {
