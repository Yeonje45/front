...
Xinha.InlineStyler.prototype.createStyleLayoutFieldset = function()
{
  ...
  if (tagname != "td" && tagname != "tr" && tagname != "th") 
  {
    ...
    td.className = "label";
    tr.appendChild(td);
    td.innerHTML = Xinha._lc("요소정렬", "InlineStyler") + ":";
    td = doc.createElement("td");
    tr.appendChild(td);
  ...
  td.className = "label";
  tr.appendChild(td);
  td.innerHTML = Xinha._lc("가로", "InlineStyler") + ":";
  td = doc.createElement("td");
  tr.appendChild(td);
  ...
  option = doc.createElement("option");
  option.innerHTML = Xinha._lc("%", "InlineStyler");
  option.value = "%";
  option.selected = /%/.test(el.style.width);
  select.appendChild(option);
  option = doc.createElement("option");
  option.innerHTML = Xinha._lc("픽셀", "InlineStyler");
  option.value = "px";
  ...
  td.appendChild(doc.createTextNode(Xinha._lc("글자 정렬", "InlineStyler") + ":"));
  select = doc.createElement("select");
  ...
  options = ["왼쪽 정렬", "중앙 정렬", "오른쪽 정렬", "전체 정렬"];
  if (tagname == "td") 
  {
    options.push("Char");
  }
  ...
  */
  ...
  td.className = "label";
  tr.appendChild(td);
  td.innerHTML = Xinha._lc("세로", "InlineStyler") + ":";
  td = doc.createElement("td");
  tr.appendChild(td);
  input = doc.createElement("input");
...
Xinha.InlineStyler.prototype.createStyleFieldset = function()
{
  ...
  tr.appendChild(td);
  td.className = "label";
  td.innerHTML = Xinha._lc("셀 배경색", "InlineStyler") + ":";
  td = doc.createElement("td");
  tr.appendChild(td);
  ...
  input.style.marginRight = "0.5em";
  td.appendChild(input);
  new Xinha.colorPicker.InputBinding(input).setColor('#000000')
  
  td.appendChild(doc.createTextNode(" " + Xinha._lc("배경 이미지 경로", "InlineStyler") + ": "));
  input = doc.createElement("input");
  ...
  tr.appendChild(td);
  td.className = "label";
  td.innerHTML = Xinha._lc("글자색", "InlineStyler") + ":";
  td = doc.createElement("td");
  tr.appendChild(td);
  input = doc.createElement("input");
  ...
  tr.appendChild(td);
  td.className = "label";
  td.innerHTML = Xinha._lc("테두리색", "InlineStyler") + ":";
  td = doc.createElement("td");
  tr.appendChild(td);
  input = doc.createElement("input");
  ...
  options = ["옵션없음", "점선", "파선", "실선", "이중선", "홈선", "액자선", "오목선", "볼록선"];
  ...
  span.innerHTML = Xinha._lc("픽셀", "InlineStyler");
  td.appendChild(span);
  ...
  if (el.tagName.toLowerCase() == "table") 
  {
    ...
    label.innerHTML = Xinha._lc("테두리 경계 없음", "InlineStyler");
