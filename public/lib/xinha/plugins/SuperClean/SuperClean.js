...
function SuperClean(editor, args)
{
  ...
  editor.config.registerButton('superclean', this._lc("Clean up HTML"), [_editor_url +'iconsets/Tango/clearformatting.svg',-2,-2], true, function(e, objname, obj) { superclean._superClean(null, obj); });
